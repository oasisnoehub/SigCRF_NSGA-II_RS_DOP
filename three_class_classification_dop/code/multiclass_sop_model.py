...
from three_class_classification_dop.tools import nsga_tool
np.random.seed(42)
def multiclass_sop_model(population_size,num_features,num_generation,drop_rate,mutation_rate,error_tolerance,model):
    ...
    X_train_t.to_csv("../review_data/X_train_t.csv", sep=',', index=False)
    X_train_val.to_csv("../review_data/X_train_val.csv", sep=',', index=False)
    y_train_t.to_csv("../review_data/y_train_t.csv", sep=',', index=False)
    y_train_val.to_csv("../review_data/y_train_val.csv", sep=',', index=False)

    X_test.to_csv("../review_data/X_test.csv", sep=',', index=False)
    y_test.to_csv("../review_data/y_test.csv", sep=',', index=False)
