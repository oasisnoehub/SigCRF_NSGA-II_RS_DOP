...
from binary_sop_model_south_s03 import *
np.random.seed(42)
# 定义种群数
population_size = 32
# 迭代次数
...
error_tolerance = 0
# =====================================
# binary standard operation process
print("========binary classification SOP : South data========")
binary_sop_model_south(population_size=population_size,
